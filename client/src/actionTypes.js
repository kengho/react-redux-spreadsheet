...
export const COPY_AREA = 'table/COPY_AREA';
export const CUT_AREA = 'table/CUT_AREA';
export const PASTE_AREA = 'table/PASTE_AREA';
export const CLEAR_AREA = 'table/CLEAR_AREA';
